                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="nama_supplier">Jenis Kategori</label>
                                    <input type="text" class="form-control" value="<?= $kategori['jenis']; ?>"
                                        name="jenis" id="jenis" placeholder="Masukkan Jenis Kategori">
                                </div>
                            </div>
